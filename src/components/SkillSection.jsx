    ...
    <div className="max-w-7xl mx-auto  ">
      ...
      <div className="grid gap-5 mx-auto overflow-x-auto md:grid-cols-2 lg:grid-cols-3  md:space-x-0 lg:gap-5 p-4">
        <motion.div
          ...
          className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400"
        >
          <figure>
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Fundamental programming language known for speed and memory
              efficiency. Solid understanding of data structures, loops,
        ...
        <div className="card bg-base-100 cursor-pointer shadow-md border-green-400 shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border">
          ...
          <div className="card-body">
            <h2 className="card-title primary">C++</h2>
            <p className="text-justify secondary">
              Object-oriented programming language that builds on C. Proficient
              in classes, inheritance, polymorphism, and standard template
        ...
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body backdrop:blur-sm">
            ...
            <p className="text-justify secondary">
              Style sheet language for designing beautiful, responsive user
              interfaces. Skilled in Flexbox, Grid, and modern layout
              techniques.
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              ...
              Experienced in building responsive, modern designs with Tailwind
              and DaisyUI.
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Powerful scripting language used to add interactivity, logic, and
              dynamic behavior to websites. Proficient in ES6+ features and DOM
              manipulation.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Superset of JavaScript that adds static types. Enhances code
              quality and developer productivity with features like interfaces
              and generics.
            </p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              ...
              Proficient in hooks, component-based architecture, routing, and
              state management.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              ...
              Familiar with file-based routing, API routes, and static site
              generation.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Google’s backend-as-a-service platform. Skilled in Firebase Auth,
              Firestore, Hosting, and integrating Firebase with React for secure
              apps.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              NoSQL database for flexible and scalable data storage. Experience
              in designing schemas, querying data, and using it with Mongoose in
              Node.js apps.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              JavaScript runtime for building fast, scalable server-side
              applications. Comfortable working with Express.js and RESTful API
              development.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Skilled in creating mobile-first and fully responsive websites
              using CSS media queries, Flexbox, Grid, and utility frameworks
              like Tailwind CSS to ensure a seamless experience across all
              devices.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Able to consume and integrate RESTful APIs and third-party
              services. Proficient in fetching, displaying, and manipulating
              data using Axios or Fetch API in both frontend and backend.
            </p>
          </div>
        </div>
        <div className="card bg-base-100 cursor-pointer shadow-md  shadow-blue-500 hover:scale-[1.02] transition-transform duration-300 ease-in-out border border-green-400">
          ...
          <div className="card-body">
            ...
            <p className="text-justify secondary">
              Comfortable with version control using Git and collaborating on
              projects via GitHub. Proficient in pushing code, managing
              branches, handling pull requests, and tracking project history.
            </p>
          </div>
        </div>
      </div>
