      ...
      <div className="transform-3d">
        ...
        >
          <p className="text-gray-200 text-lg leading-relaxed lg:text-justify text-left secondary">
            ...
            University Bangladesh, Dhaka, after successfully completing a
            Diploma in Engineering (Computer Science).
          </p>
          <p className="text-gray-200 mt-4 text-lg leading-relaxed lg:text-justify text-left secondary">
            ...
            set in full-stack development, specializing in React.js, Next.js and
            Node.js, Express.js, MongoDB, PostgreSQL. I enjoy building
            responsive, user-friendly web applications that solve real problems
          ...
          <p className="text-gray-200 text-lg mt-4 leading-relaxed lg:text-justify text-left secondary">
          ...
          <div className="flex justify-around gap-10 mt-8 border-t-2 border-blue-500 p-5">
            <div>
              <div>
                ...
                <p className="font-semibold text-left secondary">
                  Md Shafayet Hossen
                </p>
              </div>
              <div className="mt-5">
                <h2 className="text-left secondary">Location</h2>
                <p className="text-left font-semibold secondary">
                  Dhaka,Bangladesh
                </p>
              </div>
            </div>
            <div>
              <div>
                ...
                <p className="font-semibold secondary overflow-wrap: wrap-anywhere text-left">
