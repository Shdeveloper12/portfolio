...
return (
    <div className=" mt-12 rounded-lg  max-w-4xl mx-auto">
        ...
        <div className="text-center">
            ...
            <p className="text-gray-600 mt-2 mb-4 secondary">
        ...
        <div className="grid flex-col-1 lg:grid-cols-2 md:flex-row gap-6 justify-center items-center">
            <div className="card card-border bg-base-100 w-96 shadow-md hover:shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-in-out">
                <div className="card-body">
                    ...
                    <p className="text-gray-500 secondary">Stamford University, Dhaka</p>
                    <p className="text-gray-500 secondary">2024 - Present</p>
                    <p className="text-gray-500 secondary">2027 - Out</p>
                    <div className="card-actions justify-end ">
                        <button className="btn btn-outline btn-primary primary">
            ...
            <div className="card card-border bg-base-100 w-96 shadow-md hover:shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-in-out">
                <div className="card-body p-8">
                    ...
                    <p className="text-gray-500 secondary">Rangpur Polytechnic Institute, Rangpur</p>
