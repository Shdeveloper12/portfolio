    ...
    <>
      <div className="max-w-7xl mx-auto my-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-5 gap-50 lg:gap-10 lg:grid-cols-2 ">
          <div className="relative w-full max-w-6xl mx-auto rounded-lg  bg-white hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="text-center space-y-5 p-10 border-2 border-gray-300  rounded-lg bg-white hover:shadow-lg transition-shadow duration-300 ">
            <div className="mt-8">
              <h2 className="text-5xl font-bold primary ">HobbyHub</h2>
      ...
      <div className="max-w-5xl mx-auto p-5 my-8">
        ...
        <div className="mt-12">
          ...
          <div className="secondary space-y-2 ml-1 text-gray-700">
            ...
            <p>
              <i class="fa-solid fa-star-of-life mr-3"></i>Enhance the social
              aspect of hobbies via group collaboration.
            </p>
          </div>
          <div className="mt-12">
            ...
            <div className="secondary space-y-2 ml-2 text-gray-700">
              ...
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Create & Manage
                Groups
              </p>
              <p>
              ...
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i> My Group Dashboard
              </p>
              <p>
              ...
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Lottie Animations &
                React Tooltips
              </p>
            </div>
          </div>
