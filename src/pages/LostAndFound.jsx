    ...
    <>
      <div className="max-w-7xl mx-auto my-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-5 gap-50 lg:gap-10 lg:grid-cols-2 ">
          <div className="relative w-full max-w-6xl mx-auto  rounded-lg  shadow-lg ">
          ...
          <div className="text-center space-y-5 p-10 border-2 border-gray-300  rounded-lg bg-white hover:shadow-lg transition-shadow duration-300 ">
            <div className="mt-8">
              <h2 className="text-5xl font-bold primary ">Lost And Found</h2>
              <p className="secondary text-gray-700">
                A Community-Driven Lost Item Recovery Platform
              </p>
            </div>
            <div className="p-4 gap-2 flex overflow-auto justify-center">
              <a
      ...
      <div className="max-w-5xl mx-auto p-5 my-8">
        <div className="">
          ...
          <p className="text-gray-700  leading-relaxed lg:text-justify text-left secondary">
        ...
        <div className="mt-12">
          ...
          <div className="secondary space-y-2 ml-1 text-gray-700">
            <p>
              <i class="fa-solid fa-star-of-life mr-3"></i>Provide a helpful
              system to report lost or found items.
            </p>
            <p>
              <i class="fa-solid fa-star-of-life mr-3"></i>Allow authenticated
              users to post, update, or delete their listings.
            </p>
            <p>
              <i class="fa-solid fa-star-of-life mr-3"></i>Secure private user
              actions with JWT and Firebase authentication.
            </p>
            <p>
            ...
            <p>
              <i class="fa-solid fa-star-of-life mr-3"></i>Deliver a seamless,
          ...
          <div className="mt-12">
            ...
            <div className="secondary space-y-2 ml-2 text-gray-700">
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Authentication &
                Authorization
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Post Lost or Found
                Items
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i> Update & Delete
                Posts
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i> Item Details Page
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Dark/Light Mode
                Toggle
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Responsive Design
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>User Avatars
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>weetAlert2 / Toasts
                / Loaders
              </p>
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Booking System
              </p>
              <p>
          ...
          <div className="ml-5">
            ...
            <div className="secondary ml-6 text-gray-700">
              <p>
          ...
          <div className="ml-5 mt-3 ">
            ...
            <div className="secondary ml-6 text-gray-700">
              ...
              <p>
                <i class="fa-solid fa-star-of-life mr-3"></i>Firebase Admin SDK
                – token verification
              </p>
              <p>
